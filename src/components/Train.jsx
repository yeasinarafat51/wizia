...
const Train = () => {
  return (
    <div className='xl:text-center text-start xl:mx-auto mx-10 space-y-4 overflow-hidden'>
      <p className='text-white  text-[40px] font-Montserrat font-[600px]'>Train your aiDR on your...</p>
      <p className='italic text-primary text-[40px] font-Montserrat font-[500px]'>prefered email st|</p>
      <p className='xl:w-[450px] text-center mx-auto text-[#FFFFFF] text-[24px] font-Work Sans font-[300px'>You’re in control. Train your aiDR on elements of your Marketing strategy.</p>
