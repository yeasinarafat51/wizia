  ...
  return (
    <div className="max-w-[1344px] border-2 shadow-lg border-[#07292F] md:mx-20 py-8 my-16">
      <div className="md:w-[582px] w-full text-center md:mx-auto ">
        ...
        <p className="text-[20px] font-[300px] text-white font-Work Sans">Keep your reps “in the air” -- out in the field and on the phone where they can build relationships.</p>
